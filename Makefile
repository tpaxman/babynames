...
cleandata : $(patsubst %,clean-data/%-babynames.csv,usa-country usa-state usa-territory alberta)
rawdata : $(patsubst %,downloads/%-babynames.zip,usa-country usa-state usa-territory) downloads/alberta-babynames.xlsx
